  ...
  return m("section.dt.w-100.vh-100.tc",
     ...
     m("div.dtc.v-mid",
      m("div.tl.w-50.bg-white.dib.shadow-4.pa4",
        m("p",`Please add one user per line, as comma separated values in the format "UserID(Matric No), User Phone Number". The password would be sent to the user via text message`),
